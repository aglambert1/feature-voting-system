...
export default function AgentJobStatus({
  ...
  // Track previous active job UUID to detect transitions, and whether
  // we've already fired onJobComplete for the current completed job.
  ...
  const fetchJobs = useCallback(async () => {
    try {
      ...
      //    completed job exists, and we haven't fired for this job yet)
